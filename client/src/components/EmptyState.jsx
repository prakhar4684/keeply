...
const configs = {
  files: {
    icon: FolderOpen,
    title: 'No files yet',
    subtitle: 'Create a folder or upload your first file to get started',
    color: 'emerald',
  },
  search: {
    icon: Search,
      ...
      {type === "files" ? (
        ...
        <div className="flex items-center gap-3">
          ...
          <motion.button
            ...
            className="flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-semibold transition-all shadow-md bg-emerald-600 text-white hover:bg-emerald-700"
          >
            <FolderPlus size={16} />
            Create Folder
          </motion.button>
          ...
          <motion.button
            ...
            className="flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-semibold transition-all shadow-md border border-gray-200 bg-white text-gray-700 hover:bg-gray-50"
          >
            <Upload size={16} />
            Upload File
          </motion.button>
