...
// ─── Pricing Plans ───────────────────────────────────────────────
// AWS S3 costs ~$0.023/GB/mo (≈ ₹1.92/GB/mo). Marked up ~3.5× for infra, bandwidth & margin.
// Pro:     50 GB × ₹1.92 × 3.5 = ~₹336  → ₹349/mo  (yearly: ₹279/mo = save ₹840/yr)
// Premium: 200 GB × ₹1.92 × 3.5 = ~₹1344 → ₹1,349/mo (yearly: ₹1,079/mo = save ₹3,240/yr)
...
const planGradients = {
  ...
  pro: {
    ...
    textPrimary: 'text-white', textSecondary: 'text-emerald-100', textMuted: 'text-emerald-200',
  },
  premium: {
  ...
  return (
    ...
    >
      ...
      <div className="px-7 pb-7 space-y-3">
        ...
        {plan.price.monthly > 0 && (
          <p className={`text-center text-xs ${isPro ? 'text-emerald-200' : 'text-gray-400'}`}>
